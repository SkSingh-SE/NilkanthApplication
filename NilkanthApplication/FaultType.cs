...
{
    public partial class FaultType : Form
    {
        public FaultType()
        {
        ...
        private void FaultType_Load(object sender, EventArgs e)
        {
            try
            {
                this.btnNew.Focus();
                this.lblUserName.Text = "User Name : " + Queries.UserName;
                this.txtSearch.Text = "Enter Fault Type Details for Search......";
        ...
        private void FaultType_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
            ...
            try
            {
                ...
                if (flag)
                {
                    ...
                    else
                    {
                        ...
                        if (flag4)
                        {
                            int num = Convert.ToInt32(Functions.GetSingleValue("select COUNT(*) from FaultType where LOWER(Name)='" + this.dgvList.CurrentRow.Cells["Name"].Value.ToString().Trim().ToLower() + "' and IsDeleted=0 and ID!=" + this.dgvList.CurrentRow.Cells["ID"].Value.ToString().Trim()).ToString());
                            bool flag5 = num > 0;
                            if (flag5)
                            {
                    ...
                    if (flag2)
                    {
                        ...
                        if (flag4)
                        {
                            try
                            {
                                ...
                                string text2 = Queries.InsertBySP("FaultType_Insert");
                                bool flag5 = text2 != "";
                                if (flag5)
                                {
                        ...
                        if (flag8)
                        {
                            ...
                            if (flag10)
                            {
                                try
                                {
                                    ...
                                    string text3 = Queries.UpdateBySP("FaultType_Update");
                                    bool flag11 = text3 != "";
                                    if (flag11)
                                    {
                    ...
                    if (flag2)
                    {
                        ...
                        if (flag3)
                        {
                            try
                            {
                                ...
                                string text = Queries.UpdateBySP("FaultType_Delete");
                                bool flag4 = text != "";
                                if (flag4)
                                {
        ...
        private void BindGrid(bool isdelete)
        {
            try
            {
                ...
                bool flag = this.txtSearch.Text == "Enter Fault Type Details for Search......";
                string text;
                if (flag)
                {
                    text = "";
                ...
                this.dataTable = Functions.GetTableDataBySPWithParam("FaultType_SelectAll", string.Concat(new string[]
                {
                    "@Search='",
                    text,
                    "',@FieldName='",
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                bool flag = this.txtSearch.Text != "Enter Fault Type Details for Search......" && this.addindex == -1 && this.editindex == -1;
                if (flag)
                {
                    this.BindGrid(true);
                }
