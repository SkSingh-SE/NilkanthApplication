...
{
    public partial class ReportConsumption : Form
    {
        string Aplyear = "";
        string Aplmonth = "";
        string fromdate = "";
        ...
        string apptime = "False";
        string appYearMonth = "False";
        string MQube = "";

        public ReportConsumption(string applydate, string applytime,string applyyearmonth, string fdate, string tdate,string year, string month, string ftime, string ttime, string clientname, string sitename, string recipename, string trucknum, string Mqube)
        {
            InitializeComponent();
            this.appDate = applydate;
            this.apptime = applytime;
        ...
        private void ReportConsumption_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("ConsumptionDS", dt));
                ...
                ReportParameter p4 = new ReportParameter("To_Time", totime);
                ReportParameter p5 = new ReportParameter("Client_Name", client);
        ...
        private DataTable GetSPResult()
        {
            ...
            try
            {
                dataTable = Functions.GetTableDataBySPWithParam("ConsumptionReportData_Select", string.Concat(new string[]
                {
                        "@ApplyDateFilter='",
                        appDate,
                        "',@ApplyTimeFilter='",
